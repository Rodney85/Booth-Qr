...
VITE_CLERK_PUBLISHABLE_KEY=pk_test_ZHJpdmVuLXJheS0wLmNsZXJrLmFjY291bnRzLmRldiQ
Quick copy
...
VITE_CLERK_PUBLISHABLE_KEY=pk_test_ZHJpdmVuLXJheS0wLmNsZXJrLmFjY291bnRzLmRldiQ
These are the same keys as you see below.
Publishable key
This key should be used in your frontend code. It can be safely shared, and does not need to be kept secret.

Public key
Never used
pk_test_Z…RzLmRldiQ
Secret keys
Secret keys grant admin-level access to sensitive operations in Clerk's backend API, including impersonating users, changing security settings and creating admin users in organizations.

default
Created Apr 20, 2026•Used 1m ago
sk_test_Z…Syg5sR9MP
Do not share these keys with anyone. If you suspect that one of your secret keys has been compromised, you should create a new key, update your code, then delete the compromised key. Clerk support will never ask you to share your secret keys.